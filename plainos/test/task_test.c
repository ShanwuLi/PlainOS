...
static int idle_task1(int argc, char *argv[])
{
	...
	tcb2 = pl_task_create("idle_task2", idle_task2, PL_CFG_TASK_PRIORITIES_MAX - 1, 256, 1, argvs2);
...
static int task_test(void)
{
	...
	test_task = pl_task_create("idle_task1", idle_task1, PL_CFG_TASK_PRIORITIES_MAX - 1, 400, 0, NULL);
	if (test_task == NULL) {
